...
<head>
    ...
    <title>Layout 11 | Interior Design</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 col-md-12">
                        <div class="white-box analytics-info" style="background: #CACFD2 ;">
                            <center>
                                <center><h2>Layout 11</h2></center>
                                <hr>
                                <div class="col-lg-4 col-md-12">
                                
										<form action="genpdf.php" method="post">
											<label for="number">Number Of Pages</label>
											<input type="number" name="number" class="form-control" placeholder="Page Number"><br>
											...
											<input type="text" name="bname" class="form-control" required placeholder="Book Name"><br>
