	...
	if (isset($_POST['set_password'])) {
        ...
        if ($password === $cpassword) {
        	...
        	if ($update_password_run) {
        		$set_password_status = "Password Updated! <a href='http://backonhost.com/login.php'> Login Now</a>";
        	}
        }
        else{
						...
						<div class="auth-form-container text-left">
							...
							<form class="auth-form resetpass-form" action="set-password.php" method="POST">                
								...
								<div class="text-center">
									<button type="submit" name="set_password" class="btn d-grid btn-danger text-white">Reset Password</button>
								</div>
